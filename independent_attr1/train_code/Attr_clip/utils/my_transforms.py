"""from git@github.com:epic-kitchens/C1-Action-Recognition-TSN-TRN-TSM.git"""
import math
import numbers
import random
...
__all__ = [
    "default_transform_ImageNet",
    "default_transform_EPIC",
    "default_transform_CLIP",
]
...
def default_transform_ImageNet(split: str) -> torchvision.transforms.Compose:
    ...
    if split == "train":
        return torchvision.transforms.Compose([
            torchvision.transforms.RandomResizedCrop(resolution),
...
def default_transform_EPIC(split: str, resolution: int) -> torchvision.transforms.Compose:
    common_transform = torchvision.transforms.Compose(
        [
            ...
            ExtractTimeFromChannel(channels=3),
        ]
    )
    ...
    if split == "train":
        return torchvision.transforms.Compose(
            [
                GroupMultiScaleCrop(
                    resolution, scales=[1, 0.875, 0.75, 0.66]
                ),
...
def default_transform_CLIP(n_px):
    return torchvision.transforms.Compose([
